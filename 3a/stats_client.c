...
int main (int argc, char *argv[]) {
    ...
    //TODO set argv[0] in stats_t, is it supposed to be in char arg[16]???
    //stat->arg = argv[0]
    ...
    int which = PRIO_PROCESS; //TODO is this the right one? could also be PRIO_PGRP or PRIO_USER
    ...
    while(1){
        ...
        //Should go to two decimal places, takes nanoseconds divides by 1e7, rounds that, then divides by the 100
